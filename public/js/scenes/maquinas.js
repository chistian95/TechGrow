ScenePrincipal.prototype.TiposMaquinas = {
...
ScenePrincipal.prototype.crearMaquina = function(x, y, tipo, orientacion='horizontal') {
...
ScenePrincipal.prototype.getCoordX = function(x) {
  return x * 32 - 16;
}
ScenePrincipal.prototype.getCoordY = function(y) {
  return y * 32 - 16;
}

ScenePrincipal.prototype.checkCogerRecursoCorrea = function(maquina, target) {
  if(!target) {
    return false;
  }
...
ScenePrincipal.prototype.cogerRecursoCorrea = function(maquina, target) {
  var self = this;
  target = target.maquina;
...
ScenePrincipal.prototype.checkTransportarRecursoMaquina = function(maquina, target) {
  var self = this;
  if(!target) {
    return false;
  }
...
ScenePrincipal.prototype.transportarRecursoMaquina = function(maquina, target) {
  var self = this;
  target = target.maquina;
...
ScenePrincipal.prototype.checkExtraerRecursoMaquina = function(maquina, target) {
  var self = this;
  if(!target) {
    return false;
  }
...
ScenePrincipal.prototype.extraerRecursoMaquina = function(maquina, target) {
  var self = this;
  target = target.maquina;
...
ScenePrincipal.prototype.checkInsertarRecursoMaquina = function(maquina, target) {
  if(!target) {
    return false;
  }
  target = target.maquina;
...
ScenePrincipal.prototype.insertarRecursoMaquina = function(maquina, target) {
  target = target.maquina;
  for(var item in maquina.inventario) {
    if(maquina.inventario[item] > 0 && (target.invEntAcept.indexOf(item) >= 0 || target.invEntAcept[0] == 'TODO')) {
